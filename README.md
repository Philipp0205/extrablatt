...
| | Free | Supporter |
|---|---|---|
| Send to Kindle | `BILLING_FREE_SENDS_PER_MONTH` (10) a month | no monthly limit, up to `MAX_SENDS_PER_DAY` (50) a day |
...
assumes "ten a month" means. `MAX_SENDS_PER_DAY` stays in force for everyone,
